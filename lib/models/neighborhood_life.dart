...
// 샘플 데이터 1
String lifeTitle = '이웃과 함께 만드는 봄 간식 저도 마음까지 따뜻해지는 봄 간식을 만나보세요.';
...
List<NeighborhoodLife> neighborhoodLifeList = [
  NeighborhoodLife(
      ...
      '내일 유기견을 데려오기로 했는데 아직 성향을 잘 몰라서 걱정이 돼요ㅜㅜ.',
      contentImgUri: 'http://picsum.photos/id/872/200/300?grayscale',
      commentCount: 11,
      authCount: 3,
      date: '3시간전',
  ),
